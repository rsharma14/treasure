...
<div class="form-container">
	...
	<form:form method="POST" modelAttribute="brandsBean"
		...
		<div class="">
			...
			<div class="form-group">
					...
					<div class="col-md-7">
						<form:select path="productCategoryId" id="productCategoryId" name="productCategoryId" 
						class="form-control" required="required" multiple="true">
						<form:options items="${productCatagoryList}"/>
						</form:select>
					</div>
			</div>
