...
<%
List<ProductTypeDto> list=(List<ProductTypeDto>)request.getAttribute("LIST");
...
<span class="menu-desc">Product Type</span>
<span class="menu-action-btn">
<a href="javascript:getModule(502,1,'a#b#c#')" class="btn btn-default btn-sm">Add</a>
</span>
</div>
...
<td>
  <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
      <li><a href="javascript:getModule(502,2,'<%=Utils.clearNull(obj.getId()) %>#b#c#')" class="dropdown-item">Edit</a></li>
      <li><a href="javascript:getModule(502,5,'<%=Utils.clearNull(obj.getId()) %>#b#c#')" class="dropdown-item">Delete</a></li>
    </ul>
  </div>
