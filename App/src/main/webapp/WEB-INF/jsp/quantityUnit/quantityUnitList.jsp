...
<%
List<QuantityUnitDto> list=(List<QuantityUnitDto>)request.getAttribute("LIST");
...
<span class="menu-desc">Quantity Unit</span>
<span class="menu-action-btn">
<a href="javascript:getModule(504,1,'a#b#c#')" class="btn btn-default btn-sm">Add</a>
</span>
</div>
...
<td>
  <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
      <li><a href="javascript:getModule(504,2,'<%=Utils.clearNull(obj.getId()) %>#b#c#')" class="dropdown-item">Edit</a></li>
      <li><a href="javascript:getModule(504,5,'<%=Utils.clearNull(obj.getId()) %>#b#c#')" class="dropdown-item">Delete</a></li>
    </ul>
  </div>
